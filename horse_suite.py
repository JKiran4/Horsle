...
def horse_suite(): # temporary name, please feel free to change if you have a preference
    ...
    suite.addTest(TestUser('test_create_track'))
    suite.addTest(TestUser('test_weather_factor'))
    suite.addTest(TestUser('test_get_track_info'))
    suite.addTest(TestUser('test_race_setup'))
    suite.addTest(TestUser('test_get_times'))
    suite.addTest(TestUser('test_get_winning_horse_id'))
